...
SUB Release_Hold_On_Block(BlockIndex, {Local} CurrentCab)
	...
	*Cab_Pointer[CurrentCab].Brake = Off
	Holds_On_Blocks[BlockIndex] = HOLDS_NO_HOLD_DECLARED
...
WHEN Block_Status[10] = BLOCK_STATUS_VACANT DO  Release_Hold_On_Block(1IF
...
WHEN Block_Status[11] = BLOCK_STATUS_VACANT DO  Release_Hold_On_Block(1IF
...
WHEN Block_Status[12] = BLOCK_STATUS_VACANT DO  Release_Hold_On_Block(1IF
